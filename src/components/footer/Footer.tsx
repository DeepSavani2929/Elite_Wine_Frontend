...
const Footer = () => {
  ...
  <div className="flex  items-start gap-10 lg:gap-20 w-full relative">
          ...
          {/* Footer Content Section */}
          <div className="flex w-[95%] xl:w-full flex-wrap lg:flex-nowrap flex-col md:flex-row xl:justify-between  gap-y-10 lg:gap-14 pb-10">
            {/* Left Section - Logo and Description */}
            <div className="flex flex-col gap-5 w-full md:w-full lg:w-[24%] xl:w-[34%]">
              <img
                src={ews}
                alt="Elite Wine Selections"
                className="object-cover object-center w-[89px] h-full"
            ...
            {/* Right Section - Links and Contact */}
            <div className="flex flex-col flex-wrap md:flex-nowrap sm:flex-row justify-between w-full  lg:w-[58%] gap-4 md:gap-12">
