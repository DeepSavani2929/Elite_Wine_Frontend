  ...
  return (
    <>
      <div className="bg-[url('/images/aboutheader3.png')] h-[320px] lg:h-[340px] xl:h-[400px] relative top-0 bg-cover bg-center">
        <div className="absolute z-50 ps-3 md:ps-6 lg:ps-7 xl:ps-12 flex flex-col gap-1 mt-52 md:mt-40 md:mt-50 xl:mt-62 w-[95%] xl:w-[80%] mx-auto">
          <p className="font-urbanist font-semibold text-base text-white">
            Home <span className="font-Poppins ms-1 me-2"> &gt;</span>About Us
            Lamm-Jung
          </p>
              ...
              <div className="flex flex-col gap-8">
                <div>
                  ...
                  <p className="mt-3 text-[#565656] font-medium font-urbanist text-sm xl:text-base leading-[26px]">
                    ...
                    cellar master Paul Will and now farms ~15 ha across central
                    and western Rheingau sites.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-3 text-[#565656] font-medium font-urbanist text-sm xl:text-base leading-[26px]">
                    Parcels span from Eltville/Erbach westward through Rüdesheim
                    and the steep slopes of Lorch, giving a cross-section of
                    Rheingau exposures and mesoclimates (river-influenced, from
                    gentler central hillsides to slatey/steep western banks).
                    The breadth of sites is the backbone for their crisp,
                    precise house style.
                  </p>
                </div>
