      ...
      <>
        <div className='bg-[#0B0B0B] relative pb-[20px] md:pb-[55px] xl:pb-[100px]'>
          <div className='flex flex-col gap-2 xl:gap-5 justify-between items-center w-full'>
            <img src={heroImg} alt="" className='mb-2 lg:mb-14 xl:mb-0 object-cover object-center h-[353px] sm:h-[360px] md:h-[420px] lg:h-[550px] xl:h-[614px]'/>
            <p className='text-[#FFFFFF] font-bold text-4xl md:text-3xl xl:text-[48px] px-0 md:px-30 lg:px-60 xl:px-80 text-center uppercase font-cormorant'>The essence of fine wine—
            without alcohol</p>
