...
const BlogChild = ({ blog, index }) => {
  ...
  return (
    <div className="flex flex-col gap-3 font-urbanist w-full lg:h-full bg-white p-2" onClick = {() => navigate(`/blog/blogDetails/${blog.id}`)}>
      ...
      {/* Title */}
      <p className="font-semibold text-md text-[#641026]">
        {blog.blogTitle}
      </p>

      {/* Short preview (EXACT screenshot style) */}
      <p
