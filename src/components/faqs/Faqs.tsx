...
// const AccordionItem = ({ id, title, content, openId, setOpenId }) => {
...
//         className="w-full flex items-center justify-between px-5 py-4 rounded-[24px] border border-[#E6E6E6] bg-white focus:outline-none transition"
//       >
//         <div>
            
//         </div>
//         <span className="text-sm md:text-base font-urbanist font-semibold text-[#1b1b1b] text-left cursor-pointer">
//           {title}
//         </span>
...
//         <div
//           ref={contentRef}
//           className="px-5 pt-4 pb-6 text-sm text-[#565656] font-medium font-urbanist"
//         >
//           {content}
//         </div>
//       </div>
...
//   const openId = openMap[groupKey] || null;
...
//   return (
//     <div className="mb-8">
//       <h3 className="font-cormorant text-lg md:text-xl tracking-wide mb-4 text-[#111111]">
//         {heading}
//       </h3>
...
//             <h2 className="font-cormorant text-3xl lg:text-4xl mb-6 tracking-wide">
...
//   return (
//     <div className="mb-5">
//       {/* OUTER BOX WRAPPING HEADER + CONTENT (as per screenshot) */}
...
//         {/* DIVIDER LINE (same as screenshot) */}
  ...
  const toggleOpen = (id) => {
    setOpenMap((prev) => {
      ...
      const updatedList = currentList.includes(id)
        ? currentList.filter((item) => item !== id) // close item
        : [...currentList, id]; // open item
