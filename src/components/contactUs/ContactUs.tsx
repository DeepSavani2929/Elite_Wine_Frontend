...
//                   <div>
//                     <p className="font-urbanist font-semibold text-md lg:text-lg">Hours:</p>
...
//                   <div>
//                     <p className="font-urbanist font-semibold text-md lg:text-lg">Phone:</p>
//                     <p className="font-urbanist text-[#565656]">
//                       +1 (631)-464-1334
//                     </p>
//                   </div>
...
//                   <div>
//                     <p className="font-urbanist font-semibold text-md lg:text-lg">Email</p>
//                     <p className="font-urbanist text-[#565656]">
...
//                 {/* Address */}
//                 <div className="flex items-start gap-2 lg:gap-6">
//                   <img src={homeIcon} alt="" className="w-9 h-9 text-[#641026]" />
//                   <div>
//                     <p className="font-urbanist font-semibold text-md lg:text-lg text-[#0B0B0B]">
//                       Address
//                     </p>
...
//                 <Facebook className="w-6 h-6 cursor-pointer" fill="black" />
//                 <Twitter className="w-6 h-6 cursor-pointer" fill="black" />
//                 <Youtube className="w-8 h-8 cursor-pointer" fill="black" />
//                 <Instagram className="w-7 h-7 cursor-pointer" fill="black" />
//               </div>
//             </div>
//           </div>
//         </div>
...
//     const validationErrors = validate(); // validate() already sets errors
...
//     // REQUIRED: Check inside validate()
//     if (Object.keys(validationErrors).length === 0) {
//       console.log("Form Submitted:", formData);
//       return true; // valid
//     }
...
//                 <Facebook className="w-6 h-6 cursor-pointer" fill="black" />
//                 <Twitter className="w-6 h-6 cursor-pointer" fill="black" />
//                 <Youtube className="w-8 h-8 cursor-pointer  text-white" fill="black"/>
//                 <Instagram className="w-7 h-7 cursor-pointer text-white" fill="black" />
//               </div>
//             </div>
//           </div>
//         </div>
